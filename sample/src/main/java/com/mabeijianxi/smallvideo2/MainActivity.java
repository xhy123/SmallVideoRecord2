...
//                    int mime_type_num = cursor.getColumnIndex(MediaStore.Images.Media.MIME_TYPE);
                    cursor.moveToFirst();
                    //String _data = cursor.getString(2);
                    String mime_type = cursor.getString(1);
                    String _data = UriToPathUtil.getRealFilePath(this,uri);

                    Log.e("SmallVideoRecord","ddddddd   "+uri+"  _data= "+_data+"  mime_type "+mime_type+"   cursor.getString(1)= "+cursor.getString(2)+" cursor.getString(3)  "+cursor.getString(3));
